...
class RespondentUser(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(
        ...
        unique=False, null=True, required=False
    )
    first_name = models.CharField(40, null=True, required=False)
...
class Question(models.Model):
    ...
    question_type = models.ManyToManyField(
        QueFieldOptions, on_delete=models.SET_DEFAULT,
...
class Vote(models.Model):
    respondent = models.ForeignKey(RespondentUser, on_delete=models.CASCADE)
    poll = models.ForeignKey(Poll, on_delete=models.CASCADE)
    choice = models.ManyToManyField(
        QueFieldOptions, on_delete=models.CASCADE,
    )
